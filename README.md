...
Depuis n'importe où (4G / autre WiFi) : https://TON-SOUS-DOMAINE.TON-DOMAINE.tld
```
...
3. Sur le téléphone (4G ou autre WiFi) : ouvre **`https://TON-SOUS-DOMAINE.TON-DOMAINE.tld`** (URL fixe), **même code**, rôle **Contrôleur**
4. Pas d’avertissement de certificat sur l’URL Cloudflare (vrai HTTPS)

### Lien fixe (Named Tunnel) — `TON-DOMAINE.tld`
...
- Le tunnel rapide Cloudflare change d’URL sans `tunnel.token` ; avec Named Tunnel → `https://TON-SOUS-DOMAINE.TON-DOMAINE.tld`
